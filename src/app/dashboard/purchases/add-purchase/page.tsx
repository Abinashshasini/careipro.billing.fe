...
import PurchaseDetailsShimmer from '@/components/shimmers/purchase-details-shimmer';
...
const AddPurchaseOrder = () => {
  ...
  }, [handleSubmit, isSubmitting, invoiceError]);
  ...
  return (
    ...
    >
      ...
      {purchaseOrderId && isLoadingPurchaseDetails && (
        <PurchaseDetailsShimmer />
      )}

      {/* Main content - hidden while loading in edit mode */}
      {(!purchaseOrderId || !isLoadingPurchaseDetails) && (
        <>
          {/* Header Code */}
